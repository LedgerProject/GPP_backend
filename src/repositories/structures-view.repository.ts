...
export class StructuresViewRepository extends DefaultCrudRepository
  <StructuresView, typeof StructuresView.prototype.idStructure, StructuresViewRelations> {
  public readonly structuresCategoriesView: HasManyRepositoryFactory<StructuresCategoriesView, typeof StructuresView.prototype.idStructure>;

  constructor(
    @inject('datasources.GppDataSource') dataSource: GppDataSource,
    @repository.getter('StructuresCategoriesViewRepository') structuresCategoriesViewRepositoryGetter: Getter<StructuresCategoriesViewRepository>,
  ) {
