...
export class NationalityLanguageRepository extends DefaultCrudRepository
  <NationalityLanguage, typeof NationalityLanguage.prototype.idNationalityLanguage, NationalityLanguageRelations> {
  public readonly nationality: BelongsToAccessor<Nationality, typeof NationalityLanguage.prototype.idNationality>;
  ...
  constructor(
    ...
    this.nationality = this.createBelongsToAccessorFor('nationality_join', nationalityRepositoryGetter);
  }
}
