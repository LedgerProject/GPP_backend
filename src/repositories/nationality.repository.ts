...
export class NationalityRepository extends DefaultCrudRepository<
  ...
  > {
  public readonly nationalityLanguage: HasManyRepositoryFactory<
  NationalityLanguage,
  typeof Nationality.prototype.idNationality
  >;
  constructor(
    @inject('datasources.GppDataSource') dataSource: GppDataSource,
    @repository.getter('NationalityLanguageRepository')
    nationalityLanguageRepositoryGetter: Getter<NationalityLanguageRepository>,
  ) {
