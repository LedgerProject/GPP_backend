...
export class StructuresCategoriesViewRepository extends DefaultCrudRepository
  <StructuresCategoriesView, typeof StructuresCategoriesView.prototype.idStructureCategory, StructuresCategoriesViewRelations> {
  public readonly structuresView: BelongsToAccessor<StructuresView, typeof StructuresCategoriesView.prototype.idStructure>;

  constructor(
    @inject('datasources.GppDataSource') dataSource: GppDataSource,
    @repository.getter('StructuresViewRepository') protected structuresViewRepositoryGetter: Getter<StructuresViewRepository>,
  ) {
