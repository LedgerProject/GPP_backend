...
export class CategoryLanguageRepository extends DefaultCrudRepository
  <CategoryLanguage, typeof CategoryLanguage.prototype.idCategoryLanguage, CategoryLanguageRelations> {
  public readonly category: BelongsToAccessor<Category, typeof CategoryLanguage.prototype.idCategory>;
